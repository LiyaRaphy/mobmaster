    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loadButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                TextInputEditText adm = (TextInputEditText)findViewById(R.id.register_);
                ...
                }else
                {
                    cr.moveToFirst();
                    try {
                        TextInputEditText name = (TextInputEditText) findViewById(R.id.edit_name_);
                        TextInputEditText roll = (TextInputEditText) findViewById(R.id.roll_);
                        TextInputEditText contact = (TextInputEditText) findViewById(R.id.contact_);
                        assert name != null;
