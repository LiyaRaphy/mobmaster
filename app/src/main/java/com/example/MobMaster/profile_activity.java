...
public class profile_activity extends AppCompatActivity{
    ...
    public void find(View view) {
        ...
        TextView textView = (TextView)findViewById(R.id.profileContentView);
        String reg = textInputEdittext.getText().toString();
        ...
        }else
        {
            ...
            String q = "SELECT * FROM ATTENDANCE WHERE register = '" + textInputEdittext.getText().toString().toUpperCase() + "'";
            ...
            }else
            {
                ...
                adapter = new profile_adapter(dates,atts,profileActivity,datesALONE,hourALONE,textInputEdittext.getText().toString().toUpperCase());
